          ...
          <div className="relative rounded-2xl overflow-hidden border border-gold-500/40 bg-gradient-to-br from-gold-600/15 via-cinema-900 to-cinema-950 p-8 text-center">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUsHaVHRPnRUyyxHOg0L08WI9rVfwOu7wswC6HJkpI7l6UNhOs0Zo4aXHfqUXbPSF0xhhys44wPxQA/pubhtml?gid=2048037794&single=true"
                  target="_blank"
                  rel="noopener noreferrer"
